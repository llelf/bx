...
K l1();ZK c5(I o,I n){R cj(o,pn((S)&n,4));} /* K1(ev){S s=xy;ZF M[16];ZJ A[999],*a=A+999,L[16],c,f;I b(){f&=7;R!f||(4>f?c==f-2:c!=f-6);}
...
K cc(I o,I x){R j2(i(0x0f20+JJ[o],16,x),i(0x0fb6,x,x));}K tst(I t,I x){R KF==t?AB("tst"):i(0x85,x,x);}K Jj(K x,I n){R cj(0x0f,c5(16+x[xn],n-4));}
K o2(I t,I o,I r,I x,I y){K z;P(KF==t,8u>y-8?AB("vex"):j2(c2(0xc5,16*(8&~r)+8*(15&~x)+(5-o?3:1)),h((C[]){0x10,0x58,0x5c,0x59,0x5e,0x2e,0,0,0x2a}[o],r,y)))
 K f(I o,I x,I y){R 127>y?i((I[]){0x8b,0x03,0x2b,0x0faf,0,0x3b,0x23}[o],x,y):rex(0,0,x,o?c3(0x83,m(3," \0\5  \7\4\1"[o],A[x]),y-128):c5(0xb8+(7&A[x]),y-128));}
 I a=126<y,s;P(0<=o&&r==x&&(!a||3-o),4-o?f(o,r,y):129-y?AB("/"):i(0xd1,16+7,r))P(0<o&&r==y,z=f(o,r,x),2-o?z:j2(z,i(0xf7,16+3,r)))P((a?3:1)<o,j2(f(0,r,x),f(o,r,y)))
 R s=0<o?0:3+(o+1)/2,rex(r,a?0:y,x,c3(0>o?1&o?0x8b:0x89:3-o?0x8d:0x6b,m(3-o?a:3,A[r],a?A[x]:4),a?(2-o?y-128:128-y)<<s:m(s,A[y],A[x])));}
K cm(I t,I x,I y){R o2(t,5,x,x,y);}K cv(I x,I y){R o2(KF,8,x,x,A[y]);}K sh(I t,I r){R AB("sh");}
...
K v(I r,K x,I n){K y=xz,z;I c=!n&&!Ay&&a==*y,l=M;K1(h){R++s,1<n?e(0,x):f(r,x);}z=h(xK[3]),M=l,y=h(y),x=b(1,xy);y=j2(y,n||c?yn-=c*B,jmp(1-n?n-xn-yn-3:zn):c1(RET));R j3(jc(x,yn),y,z);}
K1(w){I i='N'==*x?L[N++]:0,j=0;V mm(K x){I i;$(Ax,if(26u>xi-'a'&&L[i=xi-'a'])M|=1<<L[i])$(':'==*x&&A(xy),i=I(xy)-'a',M&=~(1<<L[i]),mm(xz))N(xn,mm(sc("{WNC",*x)?xK[xn-1-i]:Xx))}mm(x);
...
K g(I c,K x){K y=c0(),z,r=c0();I i=0,l=a?M:0;W(++i<xn){z=Xx;I l=M&1<<i,b=Az||128>*z&&':'-*z||i-L[I(zy)-'a'],h=2-i||Az||26>c;z=f(i,z);if(!h)z=j3(psh(0,3),z,pop(0,3));
...
K d(I r,K x){P(Ax,(r=q(x))?M|=1<<r,u(r,c0()):x)I1(h){I t=T[xi-'a'];R 14==t?-2:13==t?-4:2*t-26;}I s=15&r,a;K y,z;S((y=xy,c(a=*x)),
 case'N':C('W',R w(x))C('$',R u(r,v(r,x,1)))C('{',R E(r,x))C('[',R g(26,x))C('a',R T[a-'a']?O2(0,1+h(xx),s,d(0,xx),d(0,y)):g(a-'a',x))C(0,R y=d(0,y),O2(t(x),U(a-128),yu,y,d(s,xz))),
 if(':'==a){P(Ay,r=L[yi-'a'],M&=~(1<<r),f(r,xz))y=d(0,yy),z=e(s,xz),x=xy;R r=zu,u(r,j2(z,O2(0,h(xx),r,d(0,xx),y)));} I m,b=t(y);
 P(3>xn,'&'==a?SH(b,e(0,y)):'%'==a?y=e(0,y),u(s,j2(y,cv(s,yu))):'\\'==a?y=e(s,y),O2(b,1,s,u(yu,c0()),y):O2(0,'#'==a?-3:'*'==a?1+h(y):'/'==a?4:U(a),s,e(s,y),kc(128+('#'==a?-1:'*'!=a))))
